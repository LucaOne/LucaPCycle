...
# for dataset
DATASET_NAME="extra_p_31_class_v3_case_02"
DATASET_TYPE="protein"
# for task
TASK_TYPE="multi_class"
TASK_LEVEL_TYPE="seq_level"
LABEL_TYPE="extra_p_31_class"
...
# word-level
codes_file="extra_p_100_codes_20000.txt"
seq_subword="extra_p_100_subword_vocab_20000.txt"
...
python run.py \
  ...
  --vector_dirpath /mnt/sanyuan.hy/workspace/vectors/lucapcycle_positives/protein/esm/esm2/3B/ \
  --matrix_dirpath /mnt/sanyuan.hy/workspace/matrices/lucapcycle_positives/protein/esm/esm2/3B/ \
  --seq_fc_size $fc_size \
